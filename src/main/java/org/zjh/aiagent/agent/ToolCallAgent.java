...
public class ToolCallAgent extends ReActAgent {
    ...
    public String act() {
        ...
        ToolExecutionResult toolExecutionResult = this.toolCallingManager.executeToolCalls(prompt, toolCallChatResponse);
